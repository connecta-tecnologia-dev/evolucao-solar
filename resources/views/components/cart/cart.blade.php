    ...
    <div class="container mx-auto px-4 max-w-3xl">
      ...
      <div class="bg-white rounded-lg shadow p-4 mb-6">
        <div class="flex flex-col gap-4">
          ...
          <div class="flex items-center gap-4 border-b pb-4">
            <img src="../../public/kit-solar-2.jpg" alt="Kit Solar Residencial 3kWp" class="w-16 h-16 object-contain rounded">
            <div class="flex-1">
          ...
          <div class="flex items-center gap-4">
            <img src="../../public/kit-solar-3.jpg" alt="Placa Solar 550W" class="w-16 h-16 object-contain rounded">
            <div class="flex-1">
      ...
      <div class="flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div class="flex gap-2">
          <a href="/index.html" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-2 rounded shadow flex items-center gap-2"><i class="fa-solid fa-arrow-left"></i> Continuar Comprando</a>
          <a href="/components/checkout/checkout.html" class="bg-yellow-400 hover:bg-yellow-300 text-blue-900 font-bold px-6 py-2 rounded shadow flex items-center gap-2">Finalizar Compra <i class="fa-solid fa-credit-card"></i></a>
        </div>
      </div>
    </div>
</section>