      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          ...
          <div class="bg-white rounded-lg shadow p-4 flex flex-col items-center hover:bg-blue-50 transition-colors duration-300">
            <img src="{{ asset('image/kit-solar-1.jpg') }}" alt="Kit Solar Residencial 3kWp" class="w-32 h-32 object-contain mb-4">
          ...
          <div class="bg-white rounded-lg shadow p-4 flex flex-col items-center">
            <img src="{{ asset('image/kit-solar-2.jpg') }}" alt="Kit Solar Empresarial 10kWp" class="w-32 h-32 object-contain mb-4">
          ...
          <a href="{{ route('product-detail') }}">
          <div class="bg-white rounded-lg shadow p-4 flex flex-col items-center">
            <img src="{{ asset('image/kit-solar-3.jpg') }}" alt="Placa Solar 550W" class="w-32 h-32 object-contain mb-4">
          ...
          <a href="{{ route('product-detail') }}">
          <div class="bg-white rounded-lg shadow p-4 flex flex-col items-center">
            <img src="{{ asset('image/kit-solar-4.jpg') }}" alt="Inversor Solar 5kW" class="w-32 h-32 object-contain mb-4">
